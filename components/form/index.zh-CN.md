...
| setFieldsValue | 设置一组输入控件的值（注意：不要在 `componentWillReceiveProps` 内使用，否则会导致死循环，[更多](https://github.com/vsi-design/vsi-design/issues/2985)） | Function({ [fieldName]: value } |
