...
| setFieldsValue | Set the value of a field.(Note: please don't use it in `componentWillReceiveProps`, otherwise, it will cause an endless loop, [more](https://github.com/vsi-design/vsi-design/issues/2985)) | Function({ [fieldName]: value } |
...
<style>
.code-box-demo .vsi-form-horizontal {
  max-width: 540px;
}
</style>
