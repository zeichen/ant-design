...
| locale       | localization configuration | Object   | [default](https://github.com/vsi-design/vsi-design/blob/master/components/date-picker/locale/example.json)  |
...
<style>
.code-box-demo .vsi-calendar-picker {
  margin: 0 8px 12px 0;
}
</style>
